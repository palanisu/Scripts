...
hosts_file=$1
OUTPUT_REPORT="/home/palani/ibm-git/outputs/dsmc_service_report_${DATE}.csv"
...
output='dsm_cmd|dsm_serv|dsm_stat'
cmd_dsm_cmd='$(sudo /etc/init.d/dsmcad restart)'
cmd_dsm_serv='$(sudo /opt/tivoli/tsm/client/ba/bin/start_daemons.ksh restart)'
cmd_dsm_stat='$(ps -ef | grep -i dsm| grep -v grep)'
